...
4 - No [Tutorial 2](https://github.com/seade-R/programacao-r/blob/master/tutorials/tutorial-02.md) veremos mais alguns aspectos básicos de manipulação de dados com _dplyr_. Utilizaremos dados de casos e óbitos de COVID-19 nos municípios do Estado de São Paulo.
